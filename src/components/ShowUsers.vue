      ...
      <div class="card-body">
        ...
        <table class="table">
          ...
          <tr v-for="user in users" :key="user.id">
            ...
            <td>{{ user.age }}</td>
            <td>
              <router-link :to="{ name: 'update-data', params: { id: user.id } }" class="btn btn-warning me-2">Update</router-link>
              <router-link :to="{ name: 'delete-account', params: { id: user.id } }" class="btn btn-primary">Delete</router-link>
            </td>
          </tr>
          </tbody>
        </table>
